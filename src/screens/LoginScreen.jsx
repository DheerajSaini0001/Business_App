...
export default function LoginScreen({ navigation }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            // 1. User Login
            let response = await fetch("https://water-record-management-system-back.vercel.app/users/login", {
                method: "POST",
            ...
            // 2. Admin Login
            response = await fetch("https://water-record-management-system-back.vercel.app/admin/admin-login", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
